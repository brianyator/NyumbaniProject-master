                    ...
                    <div class="col-lg-4">
                        <div class="profile-agent-widget">
                            <ul>
                                ...
                                <li>Email <span>sam@nyumbani.com</span></li>
                                <li>Phone <span>254-455-688</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="profile-agent-newslatter">
                            <h5>Send Message to Sam</h5>
                            <form action="#">
                ...
                <div class="col-lg-4">
                    <div class="property-item">
                        ...
                        <div class="pi-text">
                            ...
                            <h5><a href="#">Home in Jaren</a></h5>
                            <p><span class="icon_pin_alt"></span> Hardy Rd, Rindge, N1</p>
                            <ul>
